...
## 动态
- **2026-04-03:** HiClaw 1.0.8 发布，引入 Kubernetes 风格的声明式资源管理，通过 YAML 定义 Worker、Team 和 Human 资源；上线 Worker 模板市场，基于模板创建 Worker；支持 Manager CoPaw 运行时；新增Nacos Skills 注册中心等。
