...
container_create_copaw_worker() {
    ...
    while true; do
        ...
        # PortBindings, network aliases, and best-effort FUSE support for AgentLoop FS self-mount.
        # Docker DNS resolves *-local.hiclaw.io via manager's network aliases; ExtraHosts remains best-effort.
        local host_config='{"NetworkMode":"hiclaw-net"}'
