...
| `HICLAW_NACOS_REGISTRY_URI` | No | `nacos://nacos.market.hiclaw.io/public` | Default Nacos registry URI for Worker template search/import, format `nacos://host[:port]/namespace` |
