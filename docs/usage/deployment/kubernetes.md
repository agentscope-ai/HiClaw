...
| `deepseek-harness` | `worker.defaultImage.deepseekHarness` | Experimental headless DeepSeek Harness Worker with Matrix text/files and object-storage-backed recovery; pinned to a tested DSH release candidate |
