...
HICLAW_COPAW_AGENTLOOP_FS_MEMORY_ENABLED=$($env:HICLAW_COPAW_AGENTLOOP_FS_MEMORY_ENABLED)
HICLAW_COPAW_AGENTLOOP_FS_MOUNT=$($env:HICLAW_COPAW_AGENTLOOP_FS_MOUNT)
HICLAW_COPAW_AGENTLOOP_FS_STORE=$($env:HICLAW_COPAW_AGENTLOOP_FS_STORE)
HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_ID=$($env:HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_ID)
HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_SECRET=$($env:HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_SECRET)
HICLAW_COPAW_AGENTLOOP_FS_SECURITY_TOKEN=$($env:HICLAW_COPAW_AGENTLOOP_FS_SECURITY_TOKEN)
HICLAW_COPAW_AGENTLOOP_FS_CMS_WORKSPACE=$($env:HICLAW_COPAW_AGENTLOOP_FS_CMS_WORKSPACE)
HICLAW_COPAW_AGENTLOOP_FS_CMS_ENDPOINT=$($env:HICLAW_COPAW_AGENTLOOP_FS_CMS_ENDPOINT)
HICLAW_COPAW_AGENTLOOP_FS_ROLE_ARN=$($env:HICLAW_COPAW_AGENTLOOP_FS_ROLE_ARN)
HICLAW_COPAW_AGENTLOOP_FS_OIDC_PROVIDER_ARN=$($env:HICLAW_COPAW_AGENTLOOP_FS_OIDC_PROVIDER_ARN)
HICLAW_COPAW_AGENTLOOP_FS_OIDC_TOKEN_FILE=$($env:HICLAW_COPAW_AGENTLOOP_FS_OIDC_TOKEN_FILE)
HICLAW_COPAW_AGENTLOOP_FS_ROLE_SESSION_NAME=$($env:HICLAW_COPAW_AGENTLOOP_FS_ROLE_SESSION_NAME)
HICLAW_COPAW_AGENTLOOP_FS_REGION_ID=$($env:HICLAW_COPAW_AGENTLOOP_FS_REGION_ID)
HICLAW_COPAW_AGENTLOOP_FS_DISABLE_MEMORY_MANAGER=$($env:HICLAW_COPAW_AGENTLOOP_FS_DISABLE_MEMORY_MANAGER)
