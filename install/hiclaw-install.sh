...
#   HICLAW_COPAW_AGENTLOOP_FS_MEMORY_ENABLED    Enable optional AgentLoop FS long-term memory for CoPaw workers (default: false)
#   HICLAW_COPAW_AGENTLOOP_FS_MOUNT             Mount path inside CoPaw workers (default: /tmp/alibabacloud)
#   HICLAW_COPAW_AGENTLOOP_FS_STORE             AgentLoop memory store name (required when enabled)
#   HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_ID     Optional static AccessKeyId for AgentLoop FS
#   HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_SECRET Optional static AccessKeySecret for AgentLoop FS
#   HICLAW_COPAW_AGENTLOOP_FS_SECURITY_TOKEN    Optional STS security token for AgentLoop FS
#   HICLAW_COPAW_AGENTLOOP_FS_CMS_WORKSPACE     AgentLoop Memory workspace ID
#   HICLAW_COPAW_AGENTLOOP_FS_CMS_ENDPOINT      AgentLoop Memory endpoint (default: cms.cn-hangzhou.aliyuncs.com)
#   HICLAW_COPAW_AGENTLOOP_FS_ROLE_ARN          Optional OIDC role ARN override for AgentLoop FS
#   HICLAW_COPAW_AGENTLOOP_FS_OIDC_PROVIDER_ARN Optional OIDC provider ARN override for AgentLoop FS
#   HICLAW_COPAW_AGENTLOOP_FS_OIDC_TOKEN_FILE   Optional OIDC token file override for AgentLoop FS
#   HICLAW_COPAW_AGENTLOOP_FS_ROLE_SESSION_NAME Optional OIDC role session name for AgentLoop FS
#   HICLAW_COPAW_AGENTLOOP_FS_REGION_ID         AgentLoop FS region for STS/OIDC flows (default: cn-hangzhou)
#   HICLAW_COPAW_AGENTLOOP_FS_DISABLE_MEMORY_MANAGER Disable CoPaw MemoryManager when AgentLoop FS is enabled (default: false)
...
# CoPaw AgentLoop FS memory (optional)
HICLAW_COPAW_AGENTLOOP_FS_MEMORY_ENABLED=${HICLAW_COPAW_AGENTLOOP_FS_MEMORY_ENABLED:-false}
HICLAW_COPAW_AGENTLOOP_FS_MOUNT=${HICLAW_COPAW_AGENTLOOP_FS_MOUNT:-/tmp/alibabacloud}
HICLAW_COPAW_AGENTLOOP_FS_STORE=${HICLAW_COPAW_AGENTLOOP_FS_STORE:-}
HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_ID=${HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_ID:-}
HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_SECRET=${HICLAW_COPAW_AGENTLOOP_FS_ACCESS_KEY_SECRET:-}
HICLAW_COPAW_AGENTLOOP_FS_SECURITY_TOKEN=${HICLAW_COPAW_AGENTLOOP_FS_SECURITY_TOKEN:-}
HICLAW_COPAW_AGENTLOOP_FS_CMS_WORKSPACE=${HICLAW_COPAW_AGENTLOOP_FS_CMS_WORKSPACE:-}
HICLAW_COPAW_AGENTLOOP_FS_CMS_ENDPOINT=${HICLAW_COPAW_AGENTLOOP_FS_CMS_ENDPOINT:-}
HICLAW_COPAW_AGENTLOOP_FS_ROLE_ARN=${HICLAW_COPAW_AGENTLOOP_FS_ROLE_ARN:-}
HICLAW_COPAW_AGENTLOOP_FS_OIDC_PROVIDER_ARN=${HICLAW_COPAW_AGENTLOOP_FS_OIDC_PROVIDER_ARN:-}
HICLAW_COPAW_AGENTLOOP_FS_OIDC_TOKEN_FILE=${HICLAW_COPAW_AGENTLOOP_FS_OIDC_TOKEN_FILE:-}
HICLAW_COPAW_AGENTLOOP_FS_ROLE_SESSION_NAME=${HICLAW_COPAW_AGENTLOOP_FS_ROLE_SESSION_NAME:-}
HICLAW_COPAW_AGENTLOOP_FS_REGION_ID=${HICLAW_COPAW_AGENTLOOP_FS_REGION_ID:-}
HICLAW_COPAW_AGENTLOOP_FS_DISABLE_MEMORY_MANAGER=${HICLAW_COPAW_AGENTLOOP_FS_DISABLE_MEMORY_MANAGER:-false}
