...
- refactor(manager): move higress-gateway-management skill to skills-alpha/ so it is not auto-loaded by Manager; remove references from TOOLS.md, README, and mcp-server-management SKILL.md
